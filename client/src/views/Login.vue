          ...
          app.axios.get('/profile').then(res => {
            ...
            crypto.subtle.importKey(
              ...
              ["decrypt"]
                ...
                crypto.subtle.decrypt({name: 'AES-CTR', counter: app.Buffer.from(app.user.private_key.iv, 'hex').buffer,
                length: 64}, key, app.Buffer.from(app.user.private_key.content, 'hex').buffer).then(res => {
